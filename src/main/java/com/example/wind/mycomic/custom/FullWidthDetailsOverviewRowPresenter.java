...
public class FullWidthDetailsOverviewRowPresenter extends RowPresenter {
    ...
    /**
     * A ViewHolder for the CustomDetailsOverviewRow.
     */
    public class ViewHolder extends RowPresenter.ViewHolder {

        protected final CustomDetailsOverviewRow.Listener mRowListener = createRowListener();

        protected CustomDetailsOverviewRow.Listener createRowListener() {
            return new DetailsOverviewRowListener();
        }

        public class DetailsOverviewRowListener extends CustomDetailsOverviewRow.Listener {
            @Override
        ...
        void onBind() {
            CustomDetailsOverviewRow row = (CustomDetailsOverviewRow) getRow();
            bindActions(row.getActionsAdapter());
    ...
    protected void onLayoutOverviewFrame(ViewHolder viewHolder, int oldState, boolean logoChanged) {
        ...
        if (wasBanner != isBanner || logoChanged) {
            ...
            if (mDetailsOverviewLogoPresenter.isBoundToImage(viewHolder.getLogoViewHolder(),
                    (CustomDetailsOverviewRow) viewHolder.getRow())) {
